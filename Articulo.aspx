...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title id="TituloPag" runat="server"></title>
    <style type="text/css">
            ...
            <div id="colIzq">
                <div class="consejo">
                    ...
                    <div class="consejo_title">
                        <span class="titulo"><asp:Label ID="titulo_art" runat="server" Text=""></asp:Label></span>
                            
                        <span class="fecha">
                             <span class="categoria">
                                 <asp:Label ID="categoria_art" runat="server" Text=""></asp:Label>
                             </span> - <asp:Label ID="fecha_creacion_art" runat="server" Text=""></asp:Label>
                        </span>           
                    </div>

                    <div class="consejo_body">
                        <div class="consejo_txt">
                            <div class="consejo_txt_wrap">
                                <asp:Label ID="contenido_art" runat="server" Text=""></asp:Label>
                            </div>
                        </div>
                        <div class="consejo_img">
                                <img src="images/user.png">
                                <p>
                                    <asp:Label ID="nombre_usu" runat="server" Text=""></asp:Label> 
                                </p>
                        </div>
                        <div class="social">
                            <!--Twitter-->
                            ...
                            <!--Facebook-->
                            <div class="fb-like" data-href="http://cal-c-tose.com.mx/Articulo.aspx?numero=<%=id_%>" data-width="350" data-layout="standard" data-action="like" data-show-faces="false" data-share="true"></div>
                        </div>
                    </div>
                </div>
